...
func CORSEnabledFunction(w http.ResponseWriter, r *http.Request) {
	...
	client, err := mongo.NewClient(options.Client().ApplyURI("mongodb+srv://Fancy21:Acermaulana21@maulana.uiq9nmy.mongodb.net/"))
	if err != nil {
	...
	collection := client.Database("gismongo").Collection("gis")
